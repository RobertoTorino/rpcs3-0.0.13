...
find_package(Qt6 6.2 CONFIG QUIET COMPONENTS Widgets Concurrent)

if(Qt6Widgets_FOUND)
	if(WIN32)
		target_link_libraries(3rdparty_qt5 INTERFACE Qt6::Widgets Qt6::Concurrent)
	else()
		find_package(Qt6 6.2 COMPONENTS DBus Gui)
		if(Qt6DBus_FOUND)
			target_link_libraries(3rdparty_qt5 INTERFACE Qt6::Widgets Qt6::DBus Qt6::Concurrent)
	...
	if(DEFINED Qt6_DIR AND NOT DEFINED Qt5_DIR)
		set(Qt5_DIR "${Qt6_DIR}" CACHE PATH "Compatibility alias for Qt deployment path")
	endif()
else()
...
if(Qt5Widgets_FOUND AND Qt5Widgets_VERSION VERSION_LESS 5.14.0)
...
if(NOT Qt5Widgets_FOUND AND NOT Qt6Widgets_FOUND)
